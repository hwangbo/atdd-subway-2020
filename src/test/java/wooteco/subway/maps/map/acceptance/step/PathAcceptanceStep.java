...
public class PathAcceptanceStep {
    public static ExtractableResponse<Response> 거리_경로_요금_조회_요청(String type, long source, long target) {
    ...
    public static void 요금을_응답(ExtractableResponse<Response> response, int fare) {
        PathResponse pathResponse = response.as(PathResponse.class);
