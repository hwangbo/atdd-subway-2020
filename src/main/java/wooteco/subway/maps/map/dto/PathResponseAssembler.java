...
public class PathResponseAssembler {
    public static PathResponse assemble(LoginMember member, SubwayPath subwayPath, Map<Long, Station> stations,
        List<Line> lines) {
        ...
        int fare = subwayPath.calculateFare(member, distance, lines);
